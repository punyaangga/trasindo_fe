...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master Data /</span> Tambah Jenis Sampah</h4>
        <div class="row">
            <!-- FormValidation -->
            <div class="col-12">
                <div class="card">
                    <h5 class="card-header">Tambah Jenis Sampah</h5>
                    <div class="card-body">
                        <form id="formValidationExamples" class="row g-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" id="formValidationName" class="form-control" placeholder="Ex : Plastik"
